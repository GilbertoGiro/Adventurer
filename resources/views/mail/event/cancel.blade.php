                ...
                <tr>
                    <td style="text-align:left;padding:14px;border-bottom:1px solid #e7e7e7">
                        ...
                        <p style="font-family:'Calibri Light', sans-serif !important;font-size:14px;">
                            Estamos enviando essa mensagem para alertá-lo de que o evento {{ $event->theme->titulo }} foi cancelado.
                            Para mais informações, entre em contato com o <b>Coordenador de Curso</b>.
                        </p>
