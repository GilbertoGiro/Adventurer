        ...
        <tbody>
            <tr>
                <td style="padding:28px;text-align:center;vertical-align:center;border-bottom:1px solid #e7e7e7">
                    <img src="{{ $message->embed(asset('img/adventurer.png')) }}" width="135px">
                </td>
            </tr>
            <tr>
                <td style="text-align:left;padding:14px;border-bottom:1px solid #e7e7e7">
                    ...
                    <p style="font-family:'Calibri Light', sans-serif !important;font-size:14px;">
                        Estamos enviando-lhe este e-mail para alertar que sempre que necessário você pode entrar em contato
                        conosco para o esclarecimento de dúvidas e/ou para realizar reclamações através do endereço de e-mail
                        aqui presente. Seja muito bem-vindo e boa sorte com seu <b>Gerenciamento Pessoal.</b> <br>
                    </p>
                    <p style="font-family:'Calibri Light', sans-serif !important;font-size:14px;">Atenciosamente, <br> <b>Personal
                            Management.</b></p>
                </td>
            </tr>
            <tr>
