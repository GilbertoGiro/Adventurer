...
@section('path')
    ...
    <li class="option-arrow white inline-block"><i class="fa fa-arrow-right"></i></li>
    <li class="option disabled-option inline-block">Adicionar Notificação</li>
@endsection
                ...
                <div class="steps text-left p-sm m-l-md m-r-md">
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="titulo" class="form-input required" id="titulo" placeholder="Título" value="{{ old('titulo') }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="stnotificacao" class="form-input required" id="stnotificacao">
                                ...
                                @foreach(App\Utilities\Arrays::status() as $key => $value)
                                    <option value="{{ $key }}" {{ ($key == old('stnotificacao')) ? 'selected' : '' }}>{{ $value }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group m-t-md">
                            ...
                            <textarea name="corpo" class="summernote" id="corpo">{{ old('corpo') }}</textarea>
                        </div>

                        <div class="form-group text-right m-t-lg">
                            <button class="button button-success">
                                Cadastrar Notificação <i class="fa fa-save"></i>
                            </button>
                        </div>
